...
**Tests**: Test tasks are MANDATORY for every behavioral change. Generated tasks
MUST cover the automated tests required to prove each user story and guard
against regressions.
...
- Reference the requirement IDs or acceptance scenarios that the task satisfies
  whenever that traceability is available
...
- [ ] T003 [P] Configure linting, formatting, typing, and test tooling
...
- [ ] T010 Establish requirement-to-task traceability for the feature
...
- [ ] TXXX Verify requirement traceability across spec, tasks, code, and tests
...
- Requirement coverage should be obvious from task wording or linked IDs
